# -*- coding: utf-8 -*-
"""
Created on Fri Sep 29 08:58:59 2017
...
dt_classifier = DecisionTreeClassifier( criterion='entropy',max_depth=50) # criterion is used to select the feature which best classifies the dataset
