...
model = RandomForestRegressor(n_estimators=100,max_depth=3,min_samples_leaf=5,random_state=3) # Using max_depth and min_samples_leaf to control the sie of the model else it will explode with the dataset we have
